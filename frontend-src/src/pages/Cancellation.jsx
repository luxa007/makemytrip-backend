    ...
    <div className="page-container">
      <div className="fade-in" style={{ marginBottom: 32 }}>
        ...
        <div style={{ display:'flex', gap:10, marginBottom:16, flexWrap:'wrap' }}>
          <Link to="/profile" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'8px 16px', borderRadius:8, background:'rgba(26,115,232,0.1)', border:'1px solid rgba(26,115,232,0.25)', color:'#1A73E8', fontSize:'0.82rem', fontWeight:600 }}>
            📋 View My Booking History →
          </Link>
          <Link to="/profile" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'8px 16px', borderRadius:8, background:'rgba(245,166,35,0.08)', border:'1px solid rgba(245,166,35,0.2)', color:'#F5A623', fontSize:'0.82rem', fontWeight:600 }}>
